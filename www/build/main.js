...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/alexd/WebstormProjects/mtechMenu/src/app/app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"/Users/alexd/WebstormProjects/mtechMenu/src/app/app.html"*/
        }),
...
var OrderSubmitPage = (function () {
    ...
    OrderSubmitPage.prototype.submitOrder = function () {
        ...
        itemsRef.push({ order: this.orderInformation });
        var toast = this.toastCtrl.create({
            message: "Order Sent",
            duration: 1000,
            position: 'top'
